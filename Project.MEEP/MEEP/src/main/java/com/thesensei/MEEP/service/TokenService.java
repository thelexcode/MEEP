...
public class TokenService {
    ...
    public static final int EXPIRE_AFTER = 10800;   //scadenza

    /**
     * createToken() -> data la matricola dell'utente e la sua email, crea il JWT
     * @param matricola
     * @param email
     * @return String (token)
     */
    ...
    /**
     * getMatricolaFromToken() -> dato in input il token, estrapola la matricola dell'utente
     * @param token
    ...
    /**
     * getEmailFromToken() -> dato in input il token, estrapola l'email dell'utente
     * @param token
     * @return String (email)
     */
